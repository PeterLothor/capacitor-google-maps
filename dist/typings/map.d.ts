...
export declare class GoogleMap {
     ...
     */
    addMarker(marker: Marker): Promise<string>;
    animateMarker(animMarker: AnimMarker): Promise<void>;
    /**
